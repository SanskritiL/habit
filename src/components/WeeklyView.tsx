...
export function WeeklyView({ habits, onToggleHabit }: WeeklyViewProps) {
  ...
  return (
    <div className="space-y-6 max-w-full">
      <h2 className="text-xl font-mono dark:text-gray-300 px-4 sm:px-0">Weekly Progress</h2>
      
      <div className="w-full overflow-x-auto sm:overflow-visible bg-white dark:bg-gray-800 rounded-lg p-4">
        <div className="min-w-full grid grid-cols-[auto_repeat(1,1fr)] gap-2">
          {/* Days column */}
          <div className="space-y-2 pr-2 border-r border-gray-200 dark:border-gray-700">
            <div className="h-12 flex items-end justify-end pb-2">
              <span className="font-mono text-sm text-gray-500 dark:text-gray-400">Days</span>
            </div>
          ...
          {/* Habits grid */}
          <div className="flex-1 pl-4 space-x-4 flex overflow-x-auto">
            {habits.map(habit => (
              <div key={habit.id} className="flex-none w-24 space-y-2">
                ...
                {weekDates.map((date, index) => (
                  <button
                    ...
                    className={`
                      h-12 w-12 border rounded-lg flex items-center justify-center
                      font-mono text-lg transition-all duration-200
                      ${habit.days[date.getDate()] ? COLORS[parseInt(habit.id) % COLORS.length] : 'border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600'}
        ...
        <div className="mt-8 pt-4 border-t border-gray-200 dark:border-gray-700">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm font-mono">
            <div className="p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
              ...
              <div className="text-lg font-bold dark:text-gray-300">Wednesday</div>
              <div className="text-gray-500 dark:text-gray-400">5 habits completed</div>
            </div>
            <div className="p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
              <div className="text-gray-500 dark:text-gray-400">Week's Average</div>
              <div className="text-lg font-bold dark:text-gray-300">72%</div>
            ...
            <div className="p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
              ...
              <div className="text-lg font-bold dark:text-gray-300">3 habits</div>
              <div className="text-gray-500 dark:text-gray-400">on track this week</div>
            </div>
          </div>
        </div>
      </div>
